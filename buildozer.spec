...
# (str) Package name
package.name = proselfcompile

# (str) Package domain (needed for android/ios packaging)
package.domain = org.proselfcompile
...
requirements = docutils, pygments, sdl2_ttf, reportlab, pillow, requests, charset-normalizer, idna, urllib3, urllib3,kivy==master, https://github.com/kivymd/KivyMD/archive/master.zip, Kivy-Garden, materialyoucolor
